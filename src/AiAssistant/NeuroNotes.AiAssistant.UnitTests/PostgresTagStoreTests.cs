...
public class PostgresTagStoreTests
{
    ...
    public async Task AddAsync_ReturnsDuplicateError_WhenSaveViolatesUniqueIndex()
    {
        ...
        await using var dbContext = new ThrowOnSaveDbContext(
            new DbContextOptionsBuilder<AiAssistantDbContext>()
    ...
    private sealed class ThrowOnSaveDbContext(DbContextOptions<AiAssistantDbContext> options)
        : AiAssistantDbContext(options)
    {
